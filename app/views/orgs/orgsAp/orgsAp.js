			...
			function($scope, orgsApApi, $location, orgsApSelectionSvc, $timeout  , orgsSelectionSvc  ) {
				...
				$scope.orgsApGridOptions = {
    				...
    				importerObjectCallback: function ( grid, newObject ) {
    					orgsApApi.save({ orgid: $scope.orgsApSelected.id }, newObject).$promise.then(function(data){
    				...
    				onRegisterApi: function(gridApi){ 
      					...
      					gridApi.edit.on.afterCellEdit($scope,function(rowEntity, colDef, newValue, oldValue){
            				...
            				orgsApApi.update(req, rowEntity).$promise.then(function(success){
