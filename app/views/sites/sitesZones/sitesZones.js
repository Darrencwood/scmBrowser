			...
			function($scope, sitesZonesApi, $location, sitesZonesSelectionSvc, $timeout  , sitesSelectionSvc  ) {
				...
				$scope.sitesZonesGridOptions = {
    				...
    				importerObjectCallback: function ( grid, newObject ) {
    					sitesZonesApi.save({ siteid: $scope.sitesZonesSelected.id }, newObject).$promise.then(function(data){
    				...
    				onRegisterApi: function(gridApi){ 
      					...
      					gridApi.edit.on.afterCellEdit($scope,function(rowEntity, colDef, newValue, oldValue){
            				...
            				sitesZonesApi.update(req, rowEntity).$promise.then(function(success){
